...
export const translations: Record<Language, Translations> = {
  zh: {
    ...
    home: {
      badge: '一人公司 · AI 赋能时代',
      badgeSubtitle: 'One Person Company · AI-Powered Era',
      title: 'ChatOPC',
      titleHighlight: '一人公司的 AI 伙伴',
      subtitle: '模型在通缩，整合在溢价。未来赚钱的不是"有 AI"的人，而是能把 AI 整合进具体场景、比别人快一步执行、建立信任壁垒的人。让一个人也能拥有团队级别的能力。',
      ctaPrimary: '了解解决方案',
      ctaSecondary: '联系我们',
      stats: {
        conversion: '10x',
  ...
  en: {
    ...
    home: {
      ...
      about: {
        badge: 'Molycure Global AI Agent',
    ...
    footer: {
      ...
      links: {
        ...
        company: {
          about: 'Molycure Global AI Agent',
          blog: 'Blog',
          careers: 'Careers',
          contact: 'Contact',
        },
