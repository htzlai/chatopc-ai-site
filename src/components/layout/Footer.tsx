...
export default function Footer() {
  ...
  const footerLinks: {
    product: Array<{ href: string; label: string; external?: boolean }>;
    company: Array<{ href: string; label: string; external?: boolean }>;
    resources: Array<{ href: string; label: string; external?: boolean }>;
    legal: Array<{ href: string; label: string; external?: boolean }>;
  } = {
    product: [
    ...
    company: [
      { href: 'https://molycure.tech', label: t.footer.links.company.about, external: true },
