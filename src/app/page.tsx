...
import SyncLoopTypewriter from '@/components/ui/SyncLoopTypewriter';
...
export default function Home() {
  ...
  return (
    <div className="overflow-hidden">
      {/* Hero Section - 优化间距和视觉层次 */}
      <section className="relative px-4 py-20 lg:px-8 lg:py-28">
        <div className="mx-auto max-w-6xl">
          ...
          >
            {/* Badge with Sync Loop Typewriter - 同步循环打字效果，去掉背景，字体放大 */}
            <motion.div
            ...
            <h1 className="mb-8 text-5xl font-bold tracking-tight sm:text-6xl lg:text-7xl leading-tight">
              <span className="text-white block mb-2">{t.home.title}</span>
          ...
          <motion.div
            ...
            className="mx-auto mt-24 grid max-w-5xl grid-cols-2 gap-8 lg:grid-cols-4"
          >
            {stats.map((stat, index) => (
              <motion.div 
                key={index} 
                className="text-center p-6 rounded-xl bg-[var(--color-bg-card)]/50 backdrop-blur-sm border border-white/5 hover:border-white/10 transition-all"
                whileHover={{ scale: 1.05, y: -4 }}
                transition={{ duration: 0.2 }}
              >
                <div className="text-4xl font-bold text-gradient lg:text-5xl mb-2">
                  {stat.value}
                </div>
      ...
      {/* Core Services Section - 优化间距和视觉层次 */}
      <section className="relative px-4 py-20 lg:px-8 lg:py-28">
        <div className="mx-auto max-w-7xl">
          ...
          >
            ...
            <h2 className="mb-6 text-4xl font-bold text-white lg:text-5xl leading-tight">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            {coreServices.map((service, index) => (
              ...
              >
                <Card variant="default" glow={index === 0} className="h-full hover:scale-105 transition-transform duration-300">
                  <CardHeader>
                    <div className="mb-4 flex h-14 w-14 items-center justify-center rounded-xl bg-gradient-primary text-white shadow-lg">
                      {service.icon}
                    </div>
                    ...
                    <p className="text-sm text-[var(--color-text-dim)] mb-3 font-medium">{service.subtitle}</p>
                  </CardHeader>
                  <CardContent>
                    <CardDescription className="text-[var(--color-text-muted)] mb-5 leading-relaxed">
                      {service.description}
                    </CardDescription>
                    <Link href="/products" className="text-sm text-[var(--color-primary)] hover:text-[var(--color-primary-light)] transition-colors inline-flex items-center gap-1 font-medium">
                      {service.link}
